"""
Django settings for IRBackend project.
...
SECRET_KEY = 'django-insecure-byw!_rf1&)5*u99mck_)x@3$6kb8hcofx))xkx1#(f3@=ap=6p'
...
WSGI_APPLICATION = 'IRBackend.wsgi.application'
